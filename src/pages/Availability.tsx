...
export default function Availability({
  ...
  const costPerHour = studioPriceSpecialty?.price * 2;
  ...
  const formatTotal = () => {
    if (!costPerHour) return "Complete the form";
    return Number(costPerHour * total()).toLocaleString("en-US", {
      style: "currency",
      currency: "USD",
    });
  };

...
const Home = () => {
  const cards = [
    { title: 'Retrato', image: '/images/cards/foto1.png' },
    { title: 'Bodas', image: '/images/cards/foto2.png' },
    { title: 'Producto', image: '/images/cards/foto3.png' },
    { title: 'Arquitectura', image: '/images/cards/foto4.png' },
    { title: 'Empresarial', image: '/images/cards/foto5.png' },
  ];
  ...
  return (
    <main>
      <section className="relative min-h-[80svh] w-full bg-black flex items-center justify-center">
        <div
          className="absolute inset-0 bg-[url('./images/bg.png')] bg-cover bg-center opacity-50"
          aria-hidden="true"
        />
        ...
        <div className="relative z-10 container px-4 flex flex-col gap-10 items-center text-center">
          ...
          <div className="w-full max-w-[80%] bg-[#444243] rounded-[20px] px-16 py-8">
      ...
      <section className="relative min-h-[50svh] w-full bg-[#DADADA] flex flex-col">
        <div className="m-10 flex flex-col gap-12">
              ...
              <CarouselContent className="">
                {cards.map((card, index) => {
                  return (
                    <CarouselItem
                      key={index}
                      className=" md:basis-1/2 lg:basis-1/3 xl:basis-1/4 gap-4"
                    >
